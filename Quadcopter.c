...
static const int ESC_PIN = 3;
static const int ESC_PIN2 = 4;
static const int ESC_PIN3 = 5;
static const int ESC_PIN4 = 6;
...
// Servo library can be used to control the esc via PPM (pulse per modulation)
Servo esc;
Servo esc2;
Servo esc3;
Servo esc4;
